...
def send_mail(*to):
    ...
    content = content.format(
        UI_AUTOMATION['TOTAL'], UI_AUTOMATION['SUCCESS'], UI_AUTOMATION['FAIL'], UI_AUTOMATION['ERROR'], UI_AUTOMATION['RATE'],
        UI_AUTOMATION1['TOTAL'], UI_AUTOMATION1['SUCCESS'], UI_AUTOMATION1['FAIL'], UI_AUTOMATION1['ERROR'], UI_AUTOMATION1['RATE'],
        UI_AUTOMATION2['TOTAL'], UI_AUTOMATION2['SUCCESS'], UI_AUTOMATION2['FAIL'], UI_AUTOMATION2['ERROR'], UI_AUTOMATION2['RATE'],
        UI_AUTOMATION3['TOTAL'], UI_AUTOMATION3['SUCCESS'], UI_AUTOMATION3['FAIL'], UI_AUTOMATION3['ERROR'], UI_AUTOMATION3['RATE'],
        UI_AUTOMATION4['TOTAL'], UI_AUTOMATION4['SUCCESS'], UI_AUTOMATION4['FAIL'], UI_AUTOMATION4['ERROR'], UI_AUTOMATION4['RATE'],
    )
