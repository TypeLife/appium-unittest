...
class Preconditions(object):
    ...
    @staticmethod
    def make_already_have_used_free_message():
        """确保非首次使用免费短信功能"""
        preconditions.connect_mobile(REQUIRED_MOBILES['Android-移动'])
        current_mobile().hide_keyboard_if_display()
...
class MessageScanTest(TestCase):
    ...
    def test_msg_huangcaizui_B_0023(self):
        ...
        Preconditions.make_already_have_used_free_message()
        # 4.在单聊会话页面
        ...
        self.assertTrue(basepg.is_exist_exit_msg())

        # Step: 2.编辑好短信，点击发送按钮
        basepg.input_free_message("测试短信，请勿回复")
        basepg.click_send_msg()
